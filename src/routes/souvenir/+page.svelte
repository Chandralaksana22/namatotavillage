...
<svelte:head>
	<title>Cinderamata - Desa Wisata Namatota</title>
</svelte:head>
<Navbar />
<div
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 caption mt-90">
				<h5>Pilih Cinderamata Terbaik</h5>
				<h1>Cinderamata Paling <span>Laris</span></h1>
			</div>
		</div>
	</div>
</div>
						...
						<div class="con">
							...
							<div class="row facilities">
								...
								<div class="col col-md-4 text-right">
									<div class="permalink">
										<a href="/souvenir/{item?.slug}"> Selengkapnya </a>
									</div>
								</div>
							</div>
						</div>
