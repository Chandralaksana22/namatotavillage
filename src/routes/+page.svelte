...
>
	<!-- Overlay -->
	<div
		style="background: rgba(0, 0, 0, 0.5); position:absolute; top:0; left:0; width:100%; height:100%; z-index:1;"
	></div>

	<!-- Content -->
	<div
		class="kenburns-inner"
		style="position:relative; z-index:2; display: flex; justify-content: center; align-items: center; height: 65%;"
	>
		<div class="v-middle caption text-center">
			<div class="container">
				<div class="row h-100 justify-content-center">
					<div class="col-md-12 text-center">
						<h4>Ayo eksplorasi keindahan bersama kami</h4>
						<h1>Jelajahi Desa Wisata <span>Namatota</span></h1>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-6 mb-30 animate-box" data-animate-effect="fadeInUp">
				<div class="section-subtitle">Permata Tersembunyi Papua</div>
				<div class="section-title">Eksplorasi <span>Desa Wisata Namatota</span></div>
				<p>
					Terletak di Pulau Namatota, Kabupaten Kaimana, Papua Barat, Desa Namatota dikenal sebagai
					“Permata Tersembunyi” yang menawarkan keindahan Teluk Triton, budaya lokal yang autentik,
					dan pesona alam yang memukau.
				</p>
				<p>
				...
				<ul class="list-unstyled about-list mb-30">
					<li>
						...
						<div class="about-list-text">
							<p>Pilihan Tepat untuk Liburan Tanpa Batas</p>
						</div>
					</li>
					<li>
						<div class="about-list-icon"><span class="ti-check"></span></div>
						<div class="about-list-text">
							<p>Destinasi Memukau, Pengalaman Tiada Duanya</p>
						</div>
					</li>
				</ul>
					...
					<div id="circle">
						...
						>
							...
							<g>
								...
								<text fill="/f2454">
									<textPath xlink:href="#circlePath"> . desa namatota . desa namatota </textPath>
								</text>
							</g>
						</svg>
					</div>
...
<section class="tours1 section-padding bg-lightnav" data-scroll-index="1">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<div class="section-subtitle"><span>Temukan Destinasi Anda</span></div>
				<div class="section-title">Paket <span>Wisata</span></div>
			</div>
		</div>
		<div class="row">
			<div class="col-md-8">
				<div class="item">
					<div class="position-re o-hidden"><img src="/img/tours/maldives1.jpg" alt="images" /></div>
...
<section class="destination1 section-padding bg-lightnav">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<div class="section-subtitle">Kamar Homestay Terbaik</div>
				<div class="section-title">Pilihan <span>Kamar Homestay</span></div>
			</div>
		</div>
		<div class="row">
			<div class="col-md-12">
					...
					<div class="owl-stage-outer">
						...
						>
							<div class="owl-item active" style="width: 292px; margin-right: 30px;">
								<div class="item">
									<div class="position-re o-hidden">
										<img src="/img/destination/greece1.jpg" alt="images" style="height: 500px; object-fit:cover" />
									</div>
							...
							<div class="owl-item" style="width: 292px; margin-right: 30px;">
								<div class="item">
									<div class="position-re o-hidden">
										<img src="/img/destination/france1.jpg" style="height: 500px; object-fit:cover" alt="images" />
									</div>
							...
							<div class="owl-item" style="width: 292px; margin-right: 30px;">
								<div class="item">
									<div class="position-re o-hidden">
										<img src="/img/destination/dubai1.jpg" style="height: 500px; object-fit:cover" alt="images" />
									</div>
							...
							<div class="owl-item" style="width: 292px; margin-right: 30px;">
								<div class="item">
									<div class="position-re o-hidden">
										<img src="/img/destination/maldives1.jpg" style="height: 500px; object-fit:cover" alt="images" />
									</div>
									<span class="category"><a>New</a></span>
									<div class="con">
										<h5>
							...
							<div class="owl-item" style="width: 292px; margin-right: 30px;">
								<div class="item">
									<div class="position-re o-hidden">
										<img src="/img/destination/greece1.jpg" style="height: 500px; object-fit:cover" alt="images" />
									</div>
									<span class="category"><a>New</a></span>
									<div class="con">
										<h5><a><i class="ti-location-pin"></i> Greece</a></h5>
